...
namespace Trackr.Api.Models
{
    ...
    #pragma warning restore CS1591
    {
        ...
        public static global::Trackr.Api.Models.GetTransactionSummaryResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Trackr.Api.Models.GetTransactionSummaryResponse();
        }
        /// <summary>
