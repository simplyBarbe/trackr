...
namespace Trackr.Api.Models
{
    ...
    public partial class PagedResponseOfAccountResponse : IParsable
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Trackr.Api.Models.PagedResponseOfAccountResponse"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Trackr.Api.Models.PagedResponseOfAccountResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Trackr.Api.Models.PagedResponseOfAccountResponse();
        }
        /// <summary>
